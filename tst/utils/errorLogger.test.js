...
describe('errorLogger', () => {
  ...
  describe('logError', () => {
    it('should log error message to console', async () => {
      ...
      expect(console.group).toHaveBeenCalledWith('🚨 Error Boundary: console-test');
      expect(console.error).toHaveBeenCalledWith('Error Message:', 'Test console logging');
    ...
    it('should log component stack when available', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Component Stack:', errorInfo.componentStack);
    });
    ...
    it('should log wallet information when available', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Wallet Address:', mockEthereum.selectedAddress);
    ...
    it('should handle logging errors gracefully', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error in error logging system:', expect.any(Error));
  ...
  describe('testErrorLogging', () => {
    it('should create and log a test error', async () => {
      ...
      expect(console.group).toHaveBeenCalledWith('🚨 Error Boundary: test-boundary');
      expect(console.error).toHaveBeenCalledWith('Error Message:', 'Custom test message');
    });

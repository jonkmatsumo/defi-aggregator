        ...
        fc.property(
          ...
          (networkKeyword, additionalText) => {
            ...
            const error = new Error(
              `${additionalText} ${networkKeyword} ${additionalText}`
            );
      ...
      fc.assert(
        fc.property(
          ...
          (walletKeyword, additionalText) => {
            ...
            const error = new Error(
              `${additionalText} ${walletKeyword} ${additionalText}`
            );
            const result = classifyError(error);
      ...
      fc.assert(
        fc.property(
          ...
          (renderKeyword, additionalText) => {
            ...
            const error = new Error(
              `${additionalText} ${renderKeyword} ${additionalText}`
            );
            const result = classifyError(error);
  ...
  describe("Error Message Retrieval", () => {
    test("should return valid message config for any error type", () => {
      fc.assert(
        fc.property(
          fc.oneof(
            ...Object.values(ERROR_TYPES).map(type => fc.constant(type))
          ),
          errorType => {
      ...
      fc.assert(
        fc.property(
          ...
          (error, errorInfo, boundaryName) => {
            ...
            expect(context.context).toHaveProperty(
              "boundaryName",
              boundaryName
            );
            expect(context.context).toHaveProperty("errorType");
            expect(Object.values(ERROR_TYPES)).toContain(
              context.context.errorType
            );
          }
        ),
        { numRuns: 100 }
        ...
        fc.property(
          ...
          (error, isDevelopment) => {
            ...
            const hasTechnicalDetails =
              formatted.hasOwnProperty("technicalDetails");

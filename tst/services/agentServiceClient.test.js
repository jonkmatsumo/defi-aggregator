...
import { AgentServiceClient, ConnectionState } from '../../src/services/agentServiceClient';
...
describe('AgentServiceClient Property-Based Tests', () => {
    ...
    test('should preserve conversation history structure', () => {
      fc.assert(fc.property(
        ...
        (messages) => {
          ...
          expect(client.conversationHistory.length).toBe(initialHistoryLength + messages.length);
          ...
          expect(client.conversationHistory.length).toBe(historyBeforeReconnect.length);
          
          // Verify each message maintains its structure
          const addedMessages = client.conversationHistory.slice(initialHistoryLength);
  ...
  describe('Basic Functionality', () => {
    ...
    test('should accept custom options', () => {
      ...
      const client = new AgentServiceClient('ws://localhost:3001', customOptions);

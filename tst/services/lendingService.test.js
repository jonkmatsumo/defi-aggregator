...
describe("LendingService", () => {
  ...
  describe("cache management", () => {
    ...
    it("should clear cache", () => {
      lendingService.cache.set("key1", {
        data: "test1",
        timestamp: Date.now(),
      });
      lendingService.cache.set("key2", {
        data: "test2",
        timestamp: Date.now(),
      });
  ...
  describe("fetchAllLendingAssets", () => {
    it("should fetch both Compound and Aave assets successfully", async () => {
      const mockResponse = {
        compound: [{ symbol: "ETH", supplyAPY: 0.025 }],
        aave: [{ symbol: "USDC", supplyAPY: 0.032 }],
      };
    ...
    it("should handle errors and return fallback data", async () => {
      ...
      expect(result.compound).toEqual(
        lendingService.getFallbackCompoundTokens()
      );
  ...
  describe("fetchTokenLendingRates", () => {
    it("should fetch lending rates for specific token", async () => {
      ...
      const result = await lendingService.fetchTokenLendingRates("USDC", [
        "aave",
        "compound",
      ]);
    ...
    it("should handle API errors", async () => {
      ...
      await expect(
        lendingService.fetchTokenLendingRates("USDC")
  ...
  describe("fetchUserBalances", () => {
    ...
    it("should return mock balances for demo purposes", async () => {
      ...
      const result = await lendingService.fetchUserBalances(
        userAddress,
        mockClient
      );
  ...
  describe("transaction methods", () => {
    describe("supplyTokens", () => {
      it("should execute supply transaction successfully", async () => {
        ...
        const result = await lendingService.supplyTokens(
          platform,
          tokenAddress,
          amount,
          userAddress,
    ...
    describe("withdrawTokens", () => {
      it("should execute withdraw transaction successfully", async () => {
        ...
        const result = await lendingService.withdrawTokens(
          platform,
          tokenAddress,
          amount,
          userAddress,
    ...
    describe("borrowTokens", () => {
      it("should execute borrow transaction successfully", async () => {
        ...
        const result = await lendingService.borrowTokens(
          platform,
          tokenAddress,
          amount,
          userAddress,
    ...
    describe("repayTokens", () => {
      it("should execute repay transaction successfully", async () => {
        ...
        const result = await lendingService.repayTokens(
          platform,
          tokenAddress,
          amount,
          userAddress,

...
describe("MessageStream", () => {
      ...
      fc.assert(
        fc.property(
          ...
          messages => {
            ...
            rerender(
              <MessageStream
                messages={[...uniqueMessages, newMessage]}
                isLoading={false}
              />
            );
  ...
  describe("Unit Tests", () => {
    it("should show welcome message when messages array is empty and not loading", () => {
      ...
      expect(
        screen.getByText(/I can help you with swaps, checking gas prices/)
      ).toBeInTheDocument();
      expect(
    ...
    it("should display loading indicator when isLoading is true", () => {
      ...
      const { container } = render(
        <MessageStream messages={messages} isLoading={true} />
      );
    ...
    it("should not display loading indicator when isLoading is false", () => {
      ...
      const { container } = render(
        <MessageStream messages={messages} isLoading={false} />
      );
    ...
    it("should not show welcome message when there are messages", () => {
      ...
      expect(
        screen.queryByText("Welcome to DeFi Chat")

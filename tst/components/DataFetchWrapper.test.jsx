...
import DataFetchWrapper, {
  InlineDataFetchWrapper,
} from "../../src/components/DataFetchWrapper";

// Mock child components
jest.mock("../../src/components/Skeleton", () => {
  return function MockSkeleton({ type, count }) {
    return (
      <div data-testid="skeleton" data-type={type} data-count={count}>
        Loading skeleton
      </div>
    );
  };
...
describe("DataFetchWrapper", () => {
  ...
  describe("Success State", () => {
    ...
    it("should work with non-function children", () => {
      ...
      expect(screen.getByTestId("static-content")).toHaveTextContent(
        "Static content"
      );
    });
  });

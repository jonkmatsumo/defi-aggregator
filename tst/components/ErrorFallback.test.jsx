      ...
      fc.assert(
        fc.property(
          fc.oneof(
            ...
            fc.record({
              message: fc.constant("wallet connection error"),
              name: fc.string(),
              stack: fc.string(),
            }),
            fc.record({
              message: fc.constant("render error"),
              name: fc.string(),
              stack: fc.string(),
            }),
            fc.record({
      ...
      fc.assert(
        fc.property(
          ...
          (error, isDevelopment) => {
            ...
            const actionHeading = Array.from(
              container.querySelectorAll("h3")
            ).find(h3 => h3.textContent.includes("What you can do"));

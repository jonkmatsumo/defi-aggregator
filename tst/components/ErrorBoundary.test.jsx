      ...
      fc.assert(
        fc.property(
          ...
          content => {
            ...
            const normalContent = container.querySelector(
      ...
      fc.assert(
        fc.property(
          ...
          ({ errorMessage, erroringSectionIndex, sectionContents }) => {
            ...
            const erroringSection = container.querySelector(
              `[data-testid="section-section-${erroringSectionIndex}"]`
            );
            expect(erroringSection).not.toBeInTheDocument();

            // Other sections should render normally
            const nonErroringSections = [0, 1, 2].filter(
              i => i !== erroringSectionIndex
            );
            nonErroringSections.forEach(i => {
              const normalSection = container.querySelector(
                `[data-testid="section-section-${i}"]`
              );
      ...
      fc.assert(
        fc.property(
          ...
          ({ errorMessage, workingSections }) => {
            ...
            expect(
              container.querySelector('[data-testid="section-error-section"]')
            ).not.toBeInTheDocument();
            ...
            workingSections.forEach((section, index) => {
              const sectionElement = container.querySelector(
                `[data-testid="section-working-${index}"]`
              );
        ...
        fc.property(
          ...
          sections => {
            ...
            normalSections.forEach(({ index }) => {
              ...
              expect(sectionElement).toBeInTheDocument();
              expect(sectionElement.textContent).toContain(
        ...
        fc.property(
          ...
          ({ numErrors, normalSections }) => {
            ...
            normalSections.forEach((content, index) => {
              const normalSection = container.querySelector(
                `[data-testid="normal-section-${index}"]`
              );
              expect(normalSection).toBeInTheDocument();
            ...
            for (let i = 0; i < numErrors; i++) {
              const errorSection = container.querySelector(
                `[data-testid="section-error-section-${i}"]`
              );
          ...
          boundaries => {
            ...
            errorBoundaries.forEach(({ index }) => {
              const contentElement = container.querySelector(
                `[data-testid="boundary-content-${index}"]`
              );

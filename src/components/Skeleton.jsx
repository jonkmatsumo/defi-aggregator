...
const SkeletonChart = ({ width = '100%', height = '300px' }) => (
  <div style={{
    ...
    <div style={{ flex: 1, display: 'flex', alignItems: 'flex-end', gap: '8px', paddingTop: '20px' }}>
...
export { SkeletonCard, SkeletonListItem, SkeletonChart, SkeletonText, SkeletonTableRow, SkeletonInline };

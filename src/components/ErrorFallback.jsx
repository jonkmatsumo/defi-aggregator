 ...
 */
const ErrorFallback = ({ error, errorInfo, resetError, isDevelopment = false }) => {
          ...
          <div style={{
            ...
            <ul style={{
              ...
              {errorDisplay.actions.map((action, index) => (
                <li key={index} style={{ marginBottom: 'clamp(4px, 0.8vw, 8px)' }}>
                  {action}
                </li>
              ))}
            </ul>
          ...
          <details style={{
            ...
            <div style={{
              ...
              <div style={{ marginBottom: 'clamp(8px, 1.5vw, 12px)' }}>
                <strong style={{ color: '#e2e8f0' }}>Error:</strong> {errorDisplay.technicalDetails.name}
              </div>
              <div style={{ marginBottom: 'clamp(8px, 1.5vw, 12px)' }}>
                <strong style={{ color: '#e2e8f0' }}>Message:</strong> {errorDisplay.technicalDetails.message}
              </div>
